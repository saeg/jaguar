...
public class ReportManualRunner {
	...
	public static void main(String[] args) throws FileNotFoundException{
		...
		programs.add(new Program("jsoup-1_5_2-5", "org.jsoup.select.CombiningEvaluator", 57));
		programs.add(new Program("jsoup-1_5_3", "org.jsoup.nodes.Node", 73));
		programs.add(new Program("jsoup-1_6_1-1", "org.jsoup.parser.CharacterReader", 17));
		programs.add(new Program("jsoup-1_6_1-2", "org.jsoup.parserTreeBuilderState.TreeBuilderState", 1451));
		programs.add(new Program("jsoup-1_6_1-3", "org.jsoup.nodes.DocumentType", 35));
		programs.add(new Program("jsoup-1_6_1-5", "org.jsoup.parser.TreeBuilderState", 283));
		programs.add(new Program("jsoup-1_6_1-6", "org.jsoup.parser.CharacterReader", 99));
		programs.add(new Program("jsoup-1_6_3-1", "org.jsoup.safety.Whitelist", 333));
		programs.add(new Program("jsoup-1_6_3-2", "org.jsoup.parser.TokeniserState", 558));
		...
		programs.add(new Program("jsoup-1_7_2-1", "org.jsoup.parser.TokeniserState", 558));
		programs.add(new Program("jsoup-1_7_2-2", "org.jsoup.nodes.Element", 1138));
		programs.add(new Program("jsoup-1_7_3-1", "org.jsoup.parser.HtmlTreeBuilder", 162));
		programs.add(new Program("jsoup-1_7_3-2", "org.jsoup.parser.HtmlTreeBuilderState", 725));
		programs.add(new Program("jsoup-1_7_3-3", "org.jsoup.parser.CharacterReader", 89));
		programs.add(new Program("jsoup-1_7_4-1", "org.jsoup.safety.Cleaner", 104));
		programs.add(new Program("jsoup-1_7_4-2", "org.jsoup.helper.DataUtil", 125));
		programs.add(new Program("jsoup-1_7_4-3", "org.jsoup.parser.DescendableLinkedList", 456));
		...
		programs.add(new Program("jsoup-1_8_4-1", "org.jsoup.select.StructuralEvaluator", 61));
		programs.add(new Program("jsoup-1_8_4-2", "org.jsoup.select.Selector", 132));
		programs.add(new Program("jsoup-1_8_4-3", "org.jsoup.helper.HttpConnection", 773));
